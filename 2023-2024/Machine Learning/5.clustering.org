...
#+subtitle: Lecture 5 - Nearest Neighbour & K-Means
#+author: Jay Morgan
#+date: November 2022
#+startup: beamer
#+include: ./header.org
...
[[file:images/knn-problem-statement.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/knn-3-classification.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/knn-all-classification.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-problem-statement.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-classified.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-classified-2.png]]

*** Starting point

K-means is an iterative algorithm, which means that the *centroids* of the clusters
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-classified-3.png]]
...
better /match/ the true clustering of data points. We'll get back to how this is
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-updated.png]]
...
#+ATTR_HTML: :width 500px
#+ATTR_LATEX: :width 0.6\textwidth
[[file:images/k-means-new-classification.png]]
...
$c_i$. The union of all centroids should be the null set:

\[
\bigcup_{i=1}^{K} S(c_i) = \emptyset
\]
...
it has clustered together. This works by evaluating the /structure/ of the clusters.

**** Intra-1                                                 :B_column:BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:BEAMER_env: column
:END:

*intra-cluster distance* -- the average distance between all data points in the same
cluster.

#+ATTR_ORG: :width 300px
#+ATTR_LATEX: :width 0.6\textwidth
#+ATTR_HTML: :width 300px
[[file:images/k-means-intra-2.png]]

**** Intra-2                                                 :B_column:BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:BEAMER_env: column
:END:

*intra-cluster diameter* -- the distance between the two most remote objects in a
cluster.

#+ATTR_ORG: :width 300px
#+ATTR_LATEX: :width 0.7\textwidth
#+ATTR_HTML: :width 300px
[[file:images/k-means-intra.png]]
...
1. *K-Nearest Neighbour* where we classify data points by looking at the existing
   classification of the existing $K$ neighbours.
2. *K-Means* where, for un-labelled data, the algorithm finds the centroid of $K$
   clusters, which we can use in future to classify new data points depending on
   which cluster they fall within.
