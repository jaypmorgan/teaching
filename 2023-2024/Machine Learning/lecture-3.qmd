...
![](images/overfit.png "Example of a well-fit model (red dashed) and a model that has overfitted to each data point (blue solid).")
...
![](images/underfit.png "A linear model (blue line) is unable to properly capture the relationship of this polynomial and so will underfit the data.")
...
![](images/validation_curves.png "Example of training and validation loss as the model iteratively trains. Both the train and validation loss decreases, up until a point where the model begins overfitting. This overfitting begins to occur when the training loss continues to decrease but the validation loss either stops decreasing or increases. Ideally, we would use the model parameters from the model with the lowest validation loss.")
...
-   Diagram     :B_column:BMCOL:
    ...
    ![](images/Precisionrecall.png "By Walber - Own work, CC BY-SA 4.0, <https://commons.wikimedia.org/w/index.php?curid=36926283>")
...
![](images/K-fold_cross_validation_EN.png "K-fold cross-validation (By Gufosowa - Own work, CC BY-SA 4.0, <https://commons.wikimedia.org/w/index.php?curid=82298768>)")
