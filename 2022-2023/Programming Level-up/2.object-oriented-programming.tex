...
\begin{frame}[label={sec:orgf3aef28},fragile]{Setting up a proxy in the .bashrc}
...
\label{sec:orgc3a9633}

\subsection{Exceptions}
\label{sec:orge4676d7}

\begin{frame}[label={sec:org2165792},fragile]{Dealing with Errors}
...
\begin{frame}[label={sec:orgcd14029},fragile]{Try-catch}
...
\begin{frame}[label={sec:orgf41451f},fragile]{Try-catch -- capturing messages}
...
\begin{frame}[label={sec:orge407777}]{Types of exceptions}
...
\begin{frame}[label={sec:org3f8fea5},fragile]{Assertions}
...
\section{OOP}
\label{sec:org35b5a8b}
\subsection{Classes}
\label{sec:org3e1912c}

\begin{frame}[label={sec:orgde904d4}]{Introduction to classes}
...
\begin{frame}[label={sec:orgca5d415},fragile]{Basic syntax}
...
\begin{frame}[label={sec:org1b0f210},fragile]{Init method}
...
\begin{frame}[label={sec:org61f3c94},fragile]{Instantiating}
...
\begin{frame}[label={sec:org577b5da},fragile]{Class variables}
...
\begin{frame}[label={sec:org1da58a0},fragile]{Class Methods}
...
\begin{frame}[label={sec:orgb9d5030},fragile]{dunder-methods}
...
\begin{frame}[label={sec:orgf3c2c29},fragile]{dunder-methods}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{python}
class OldVector:
    def __init__(self, x, y):
        self.x = x
...
\begin{frame}[label={sec:org913833c},fragile]{dunder-methods}
...
\begin{frame}[label={sec:org20f9a82},fragile]{\texttt{\_\_len\_\_}}
...
\begin{frame}[label={sec:org1014c56},fragile]{\texttt{\_\_getitem\_\_}}
...
\begin{frame}[label={sec:orgdd6ed34},fragile]{\texttt{\_\_call\_\_}}
...
\begin{frame}[label={sec:org6cf1742},fragile]{\texttt{\_\_iter\_\_} and \texttt{\_\_next\_\_}}
...
\begin{frame}[label={sec:org1445943},fragile]{\texttt{\_\_iter\_\_} and \texttt{\_\_next\_\_}}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{python}
class Primes:
    def __init__(self):
...
\begin{frame}[label={sec:org7b66c49},fragile]{\texttt{\_\_iter\_\_} and \texttt{\_\_next\_\_}}
...
\begin{frame}[label={sec:org3b9382a},fragile]{Inheritance}
...
\begin{frame}[label={sec:org120a087},fragile]{Inheritance}
...
\begin{frame}[label={sec:org76a0b6a},fragile]{Inheritance}
...
\begin{frame}[label={sec:org3f097ac},fragile]{Inheritance}
...
\section{Exercise}
\label{sec:org3a78ce5}

\subsection{Exercise}
\label{sec:org9aa5678}

\begin{frame}[label={sec:org0e53eae},fragile]{An object based library system}
...
\begin{frame}[label={sec:org854a6a2},fragile]{Adding data}
...
\begin{frame}[label={sec:org55ec388},fragile]{Printed representation -- challenge.}
