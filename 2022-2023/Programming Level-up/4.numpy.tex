...
\begin{frame}[label={sec:org0fbd932},fragile]{Install NumPy}
...
\begin{frame}[label={sec:org082596b},fragile]{Creating a numpy array}
...
\label{sec:org68193b1}

\begin{frame}[label={sec:org1f9846c},fragile]{Basic attributes}
...
\begin{frame}[label={sec:orgfc0b72f},fragile]{Different data types}
...
\begin{frame}[label={sec:org90f5229},fragile]{Creating arrays with different dtypes}
...
\begin{frame}[label={sec:orgf29e5a5},fragile]{Add a dimension}
...
\begin{frame}[label={sec:org7e543b2},fragile]{Add a dimension}
...
\begin{frame}[label={sec:org339f7c5},fragile]{Remove a dimension}
...
\begin{frame}[label={sec:orgff6babd},fragile]{More complex operations}
...
\begin{frame}[label={sec:orgc7e24db},fragile]{More complex operations}
...
\begin{frame}[label={sec:org5b1f08a},fragile]{More complex operations}
...
\begin{frame}[label={sec:orgc8b4e59},fragile]{Vectorizing a function}
...
\begin{frame}[label={sec:orge29972c},fragile]{Vectorize a function}
...
\begin{frame}[label={sec:orga73719b},fragile]{Vectorize a function}
...
\begin{frame}[label={sec:org16e6092}]{Reading more}
