...
\label{sec:orgf5707f7}

\subsection{Course introduction}
\label{sec:orgdce5c7b}

\begin{frame}[label={sec:org790ee67}]{What\ldots{}? Why\ldots{}?}
\begin{itemize}
...
\begin{frame}[label={sec:orgf7858fb}]{What is this course going to teach me?}
\begin{enumerate}
...
\begin{frame}[label={sec:org768f284}]{How the course will be delivered}
\begin{itemize}
...
\begin{frame}[label={sec:org0c8dc0b}]{Python}
\begin{columns}
...
\begin{frame}[label={sec:org837566f},fragile]{A first program}
...
\begin{frame}[label={sec:org3aee153},fragile]{Running this program}
...
\begin{frame}[label={sec:org411c13d},fragile]{An alternative method of running python}
...
\begin{frame}[label={sec:org3d24d8a},fragile]{Variables}
...
\label{sec:orga281cdd}

\begin{frame}[label={sec:org1cc0783},fragile]{Primitive data types}
...
\begin{frame}[label={sec:org037eba2},fragile]{Primitive data type}
...
\begin{frame}[label={sec:org83ac4b9},fragile]{Basic Math with primitives}
...
\begin{frame}[label={sec:org92bb9d1},fragile]{Tuples}
 \begin{minted}[]{python}
my_tuple = (1, 56, -2)
\end{minted}
...
\begin{frame}[label={sec:org5449ffd},fragile]{Tuples}
...
\begin{frame}[label={sec:org4b68ab6},fragile]{Sets}
...
\begin{frame}[label={sec:orgdda3508},fragile]{Boolean Logic}
...
\begin{frame}[label={sec:orgaa4b252},fragile]{Boolean Logic}
...
\begin{frame}[label={sec:org948a7c1},fragile]{Boolean Logic}
...
\begin{frame}[label={sec:orgdcd5ed8},fragile]{Boolean Logic}
...
\begin{frame}[label={sec:org6fab3bd},fragile]{Boolean Logic}
