...
\label{sec:org9f09a47}

\begin{frame}[label={sec:orga41aa7a},fragile]{Source code}
...
\begin{frame}[label={sec:orgefd504f}]{References}
...
\begin{frame}[label={sec:orga69066a}]{About Me}
...
\begin{frame}[label={sec:orgb61f391}]{Where you can find the resources}
...
\label{sec:org9d4501b}

\subsection*{Learning about Learning}
\label{sec:orgbc414d0}

\begin{frame}[label={sec:orgd897a6b}]{Let's answer the question of learning}
...
\begin{frame}[label={sec:org77a4987}]{Study of Mice}
...
\begin{frame}[label={sec:org2815f8a}]{Bait-shyness}
...
\begin{frame}[label={sec:orgbf51b50}]{Iris Dataset -- Tabular Classification}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:orgdca7f1b}]{Iris Dataset -- features}
\begin{columns}
...
\begin{frame}[label={sec:orgd15e72d},fragile]{Iris Dataset -- example rows}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{julia}
...
\begin{frame}[label={sec:orge2eccf1}]{MNIST Dataset -- Image Classification}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org49dcac8}]{MNIST Dataset -- Features}
\begin{itemize}
...
\begin{frame}[label={sec:org4538926},fragile]{MNIST Dataset -- Example Rows}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{julia}
...
\begin{frame}[label={sec:orgce84ed0},fragile]{Large Movie Review Dataset -- Text Classification/Regression}
 \begin{verbatim}
...
\label{sec:orge8356a3}

\begin{frame}[label={sec:orga22eb9e}]{Concerns \& Considerations}
...
\begin{frame}[label={sec:orgba4c12a}]{Compute resources -- environmental concerns}
\begin{quote}
...
\begin{frame}[label={sec:org2632851}]{Bias in language models}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:orga1f918a}]{Personal information}
...
\begin{frame}[label={sec:orgf85f335}]{Mental health of optimisation algorithms}
...
\section*{Summary}
\label{sec:org95a95a7}

\begin{frame}[label={sec:org82a61d2}]{What is Machine Learning}
\begin{itemize}
