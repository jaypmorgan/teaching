...
\begin{frame}[label={sec:org0e17c3f}]{Reinforcement Learning}
...
\begin{frame}[label={sec:org8b6c3c2}]{What will our data look like?}
...
\begin{frame}[label={sec:orgc002034}]{Tables}
...
\begin{frame}[label={sec:orga0f6e36}]{Images/Videos}
...
\begin{frame}[label={sec:orga13dbbc}]{Text}
...
\begin{frame}[label={sec:orgdea1eaa}]{Tokenisation of text}
"this is a sentence, that shouldn't be misunderstood."
...
\begin{frame}[label={sec:org970533c}]{Time-series}
...
\label{sec:org474699e}

\begin{frame}[label={sec:org0016b29}]{Example Problems}
...
\begin{frame}[label={sec:orgecafba1}]{Types of Outputs -- Regression \& Classification}
...
\begin{frame}[label={sec:org60ccf51}]{Iris Dataset -- Tabular Classification}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org88c8732}]{Iris Dataset -- features}
\begin{columns}
...
\label{sec:orga46306b}

\begin{frame}[label={sec:org58f20f6}]{Concerns \& Considerations}
...
\begin{frame}[label={sec:orgdc5ec09}]{Compute resources -- environmental concerns}
\begin{quote}
...
\begin{frame}[label={sec:org3a5efe4}]{Bias in language models}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org8eb402f}]{Personal information}
...
\begin{frame}[label={sec:org3b1ed34}]{Mental health of optimisation algorithms}
...
\section*{Summary}
\label{sec:org5d67861}

\begin{frame}[label={sec:orgafff6b2}]{What is Machine Learning}
\begin{itemize}
