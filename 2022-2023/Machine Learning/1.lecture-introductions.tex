...
\label{sec:orgc08d2f6}

\begin{frame}[label={sec:org4ba0014},fragile]{Source code}
...
\begin{frame}[label={sec:orgcf8b98d}]{References}
...
\begin{frame}[label={sec:org197f6bd}]{About Me}
...
\begin{frame}[label={sec:org6f9a531}]{Where you can find the resources}
...
\label{sec:org0d9491c}

\subsection*{Learning about Learning}
\label{sec:org528769b}

\begin{frame}[label={sec:org8c6bb27}]{Let's answer the question of learning}
...
\begin{frame}[label={sec:org5cb2679}]{Study of Mice}
...
\begin{frame}[label={sec:orge3a4c18}]{Bait-shyness}
...
\begin{frame}[label={sec:org496ce2e}]{Reinforcement Learning}
...
\begin{frame}[label={sec:orgaba213d}]{What will our data look like?}
...
\begin{frame}[label={sec:orgaf22a3a}]{Tables}
...
\begin{frame}[label={sec:org331fdcd}]{Images/Videos}
...
\begin{frame}[label={sec:org07defa8}]{Text}
...
\begin{frame}[label={sec:orgc1ca313}]{Tokenisation of text}
"this is a sentence, that shouldn't be misunderstood."
...
\begin{frame}[label={sec:orga8a7d8b}]{Time-series}
...
\label{sec:org71bd78e}

\begin{frame}[label={sec:orgc1f0043}]{Example Problems}
...
\begin{frame}[label={sec:orgc7189f9}]{Types of Outputs -- Regression \& Classification}
...
\begin{frame}[label={sec:org7a225fa}]{Iris Dataset -- features}
\begin{columns}
...
\begin{frame}[label={sec:orga92b559},fragile]{Iris Dataset -- example rows}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{julia}
...
\begin{frame}[label={sec:orgd492a88}]{MNIST Dataset -- Image Classification}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org035b996}]{MNIST Dataset -- Features}
\begin{itemize}
...
\begin{frame}[label={sec:orge81af35},fragile]{MNIST Dataset -- Example Rows}
 \begin{minted}[frame=lines,linenos=true,firstnumber=last,fontsize=\footnotesize,bgcolor=LightGray,xleftmargin=5pt,tabsize=2,breaklines=true,numbersep=10pt]{julia}
...
\begin{frame}[label={sec:org31fdf17},fragile]{Large Movie Review Dataset -- Text Classification/Regression}
 \begin{verbatim}
...
\label{sec:org4cbe0e4}

\begin{frame}[label={sec:org31665b9}]{Concerns \& Considerations}
...
\begin{frame}[label={sec:org7060d3d}]{Compute resources -- environmental concerns}
\begin{quote}
...
\begin{frame}[label={sec:org40db301}]{Bias in language models}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org5eb42e3}]{Personal information}
...
\begin{frame}[label={sec:orgde83c6b}]{Mental health of optimisation algorithms}
...
\section*{Summary}
\label{sec:orgc6ad9b2}

\begin{frame}[label={sec:org09711a7}]{What is Machine Learning}
\begin{itemize}
