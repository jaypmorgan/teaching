...
\label{sec:org2c83376}

\begin{frame}[label={sec:org085b936}]{Linear models}
...
\begin{frame}[label={sec:orgebe6a8c}]{Multiple variables}
...
\begin{frame}[label={sec:org4bec896}]{Supporting example}
...
\begin{frame}[label={sec:orged6ff55}]{Multi-class vs binary classification}
\begin{columns}
...
\label{sec:org95b8b70}

\begin{frame}[label={sec:org500142e}]{Probability likelihood}
\begin{center}
...
\begin{frame}[label={sec:org5f67727}]{Making it linear}
...
\label{sec:org0715f62}

\begin{frame}[label={sec:org66f0014}]{Enter the maximum likelihood}
...
\begin{frame}[label={sec:org18d3d42}]{Back to the probability curve}
\begin{center}
...
\begin{frame}[label={sec:orgc6de91c}]{Likelihood}
...
\begin{frame}[label={sec:org62d68c6}]{Optimising the curve}
\url{images/lr\_learn.gif}
\end{frame}

\subsection*{Binary Cross-Entropy}
\label{sec:org9df8531}
\begin{frame}[label={sec:org351feb6}]{Binary Cross-Entropy}
